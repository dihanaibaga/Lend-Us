                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown"><i data-feather="file-text"></i><span data-i18n="Pages">Pages</span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="page-faq.html" data-toggle="dropdown" data-i18n="FAQ"><i data-feather="help-circle"></i><span data-i18n="FAQ">FAQ</span></a>
                            </li>
                ...
                <section id="faq-search-filter">
                    <div class="card faq-search" style="background-image: url('../../../app-assets/images/banner/banner.png')">
                        <div class="card-body text-center">
                            <!-- main title -->
                            <h2 class="text-primary">Mencari jadwal kosong</h2>

                            <!-- subtitle -->
                            <p class="card-text mb-2">Pilih kategori dan telusuri data di bwah ini</p>
                                ...
                                <ul class="nav nav-pills nav-left flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="delivery" data-toggle="pill" href="#faq-delivery" aria-expanded="false" role="tab">
                                            ...
                                            <span class="font-weight-bold">Zoom</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="cancellation-return" data-toggle="pill" href="#faq-cancellation-return" aria-expanded="false" role="tab">
                                            ...
                                            <span class="font-weight-bold">Laboratorium</span>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="faq-payment" aria-labelledby="payment" aria-expanded="true">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span>Mobil dinas plat merah merek toyota inova</span>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                            <div class="card mt-2">
                                                <div class="card-header">
                                                    <h4 class="card-title">Data penggunaan</h4>
                                                </div>
                                                <div class="card-body">
                                                    <p class="card-text">
                                                        berikut ini merupakan data peminjaman yang sudah tercatat di aplikasi kami, silahkan sesuaikan jadwal anda untuk mengindari bentrok jadwal dangan referensi di bawah ini.
                                                    </p>
                                                </div>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Febri Iswil</td>
                                                                <td> 10 Mei 2021 </td>
                                                                <td><span class="badge badge-pill badge-light-primary mr-1">Selesai</span></td>
                                                                <td>3 Hari </td>
                                                            </tr>
