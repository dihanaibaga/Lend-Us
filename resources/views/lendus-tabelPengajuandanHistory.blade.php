                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown"><i data-feather="edit"></i><span data-i18n="Forms &amp; Tables">Forms &amp; Tables</span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="table-bootstrap.html" data-toggle="dropdown" data-i18n="Table"><i data-feather="server"></i><span data-i18n="Table">Table</span></a>
                            </li>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Data Peminjaman</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Peminjaman</a>
                                    </li>
                                    <li class="breadcrumb-item active">Peminjaman
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row" id="table-hover-animation">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    Seluruh data pengajuan yang belum di proses oleh admin.
                                </p>
                            </div>
                                ...
                                <table class="table table-hover-animation">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Laboratorium</td>
                                            <td> 15 Mei 2021</td>
                                            <td><span class="badge badge-pill badge-light-warning mr-1">Belum di Proses</span></td>
                                            <td>
                                                <div class="dropdown">
