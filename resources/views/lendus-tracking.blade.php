                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown"><i data-feather="file-text"></i><span data-i18n="Pages">Pages</span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="page-knowledge-base.html" data-toggle="dropdown" data-i18n="Knowledge Base"><i data-feather="info"></i><span data-i18n="Knowledge Base">Knowledge Base</span></a>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card knowledge-base-bg text-center" style="background-image: url('../../../app-assets/images/banner/banner.png')">
                                <div class="card-body">
                                    <h2 class="text-primary">Lacak Progres Peminjaman</h2>
                                    <p class="card-text mb-2">
                                        <span>Untuk pencarian Spesifik: </span><span class="font-weight-bolder">Masukkan id peminjaman yang di kirimkan ke email <br> atau telusuri manual pada data dibawah ini</span>
                                    </p>
                                    <form class="kb-search-input">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" id="searchbar" placeholder="id peminjaman..." />
                                        </div>
                                    </form>
                                </div>
                            </div>
                                ...
                                <a href="page-kb-category.html">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <p class="text-body mt-1 mb-0">
                                            Peminjaman telah berhasil, silahkan klik detail untuk melihat infirmasi peminjaman lebih lanjut
                                        </p>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12 kb-search-content">
                            <div class="card">
                                <a href="page-kb-category.html">
                                    ...
                                    <div class="card-body text-center">
                                        <h4>Peminjaman 3</h4>
                                        <p class="text-body mt-1 mb-0">Peminjaman telah berhasil, silahkan klik detail untuk melihat infirmasi peminjaman lebih lanjut</p>
                                    </div>
                                </a>
                            </div>
                        </div>
